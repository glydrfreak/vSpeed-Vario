...
(library Library_1
	...
	(patternDef "JS202011SCQN" (originalName "JS202011SCQN")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt -0.335, 0.068) (textStyleRef "Default") (isVisible True))
		)
		...
		(layerContents (layerNumRef 18)
			(arc (pt -3.578, -3.968) (radius 0.07159) (startAngle 0.0) (sweepAngle 0.0) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(arc (pt -3.578, -3.968) (radius 0.07159) (startAngle 180.0) (sweepAngle 180.0) (width 0.2))
		)
	)
	...
	(compDef "JS202011SCQN" (originalName "JS202011SCQN") (compHeader (numPins 6) (numParts 1) (refDesPrefix S)
		...
		(attr "Datasheet Link" "http://www.ckswitches.com/media/1422/js.pdf")
	)
