...
import com.braedin.butler.vspeed.vario.app.update.FirmwareUpdater;
import com.braedin.butler.vspeed.vario.app.update.ReleasesParser;
import com.braedin.butler.vspeed.vario.ble.BleDevicesScanner;
import com.braedin.butler.vspeed.vario.ble.BleManager;
import com.braedin.butler.vspeed.vario.ble.BleUtils;
import com.braedin.butler.vspeed.vario.ui.utils.DialogUtils;
...
public class MainActivity extends AppCompatActivity implements BleManager.BleManagerListener, BleUtils.ResetBluetoothAdapterListener, FirmwareUpdater.FirmwareUpdaterListener {
    ...
    private final static int kComponentsNameIds[] = {
            ...
            R.string.scan_connectservice_vSpeedVario
    };
                ...
                .setItems(items, new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int which) {
                        switch (kComponentsNameIds[which]) {
                            ...
                            case R.string.scan_connectservice_vSpeedVario: {           // v^SPEED VARIO
                                mComponentToStartWhenConnected = vSpeedVarioActivity.class;
                                break;
                            }
                        }
