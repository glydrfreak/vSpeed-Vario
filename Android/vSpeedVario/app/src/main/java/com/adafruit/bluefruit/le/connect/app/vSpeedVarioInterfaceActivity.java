...
public class vSpeedVarioInterfaceActivity extends AppCompatActivity implements BleManager.BleManagerListener {

//==========================================================================================================================/
    // Log
    private final static String TAG = vSpeedVarioInterfaceActivity.class.getSimpleName();
    ...
    protected void sendData(byte[] data, SendDataCompletionHandler completionHandler) {
        ...
        sendDataRunnable = new Runnable() {
            ...
            public void run() {
                ...
                vSpeedVarioInterfaceActivity.this.sendDataRunnable = null;
                vSpeedVarioInterfaceActivity.this.sendDataCompletionHandler = null;
