...
import com.braedin.butler.vspeed.vario.app.vSpeedVarioActivity;
...
//                PreferenceManager.setDefaultValues(getActivity(), R.xml.preferences, true);
    ...
    public static int getUartTextMaxPackets(Context context) {
        ...
        String uartTextMaxPacketsString = sharedPreferences.getString("pref_uarttextmaxpackets", "" + vSpeedVarioActivity.kDefaultMaxPacketsToPaintAsText);

        // Extract integer (and check for exceptions)
        int uartTextMaxPackets = vSpeedVarioActivity.kDefaultMaxPacketsToPaintAsText;
        try {
